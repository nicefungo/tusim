...
def generate_header(config, output_path):
    ...
    L(f'#define TU_DMA_READ_BURST_ISSUE_CYCLES {dma.get("read_burst_issue_cycles", dma.get("burst_issue_cycles", 0))}')
    L(f'#define TU_DMA_WRITE_BURST_ISSUE_CYCLES {dma.get("write_burst_issue_cycles", dma.get("burst_issue_cycles", 0))}')
    L('#define TU_DMA_BURST_SEGMENTATION_AGGREGATE 0')
    L('#define TU_DMA_BURST_SEGMENTATION_LOGICAL_SEGMENTS 1')
    segment_map = {'aggregate': 0, 'logical_segments': 1}
    L(f'#define TU_DMA_BURST_SEGMENTATION {segment_map[dma.get("burst_segmentation", "aggregate")]}')
    L('#define TU_DMA_BASE_LATENCY_SCOPE_DESCRIPTOR 0')
    ...
    L('#define TU_DMA_AGING_METRIC_GRANTS 0')
    L('#define TU_DMA_AGING_METRIC_CYCLES 1')
    ...
    L('    uint32_t dma_read_burst_issue_cycles;')
    L('    uint32_t dma_write_burst_issue_cycles;')
    L('    bool     dma_read_burst_issue_configured;')
    ...
    L(f'        .dma_read_burst_issue_cycles = TU_DMA_READ_BURST_ISSUE_CYCLES,')
    L(f'        .dma_write_burst_issue_cycles = TU_DMA_WRITE_BURST_ISSUE_CYCLES,')
    L(f'        .dma_read_burst_issue_configured = false,')
