...
.PHONY: test-dma-channel-sweep
test-dma-channel-sweep: tests/test_dma_channel_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-channel-sweep

.PHONY: test-dma-arbitration-sweep
test-dma-arbitration-sweep: tests/test_dma_arbitration_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-arbitration-sweep

.PHONY: test-dma-binding-sweep
test-dma-binding-sweep: tests/test_dma_binding_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-binding-sweep

.PHONY: test-dma-bus-width-sweep
test-dma-bus-width-sweep: tests/test_dma_bus_width_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-bus-width-sweep

.PHONY: test-dma-directional-latency-sweep
test-dma-directional-latency-sweep: tests/test_dma_directional_latency_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-directional-latency-sweep

.PHONY: test-dma-burst-issue-sweep
test-dma-burst-issue-sweep: tests/test_dma_burst_issue_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-burst-issue-sweep

.PHONY: test-dma-directional-burst-sweep
test-dma-directional-burst-sweep: tests/test_dma_directional_burst_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-directional-burst-sweep

.PHONY: test-dma-directional-issue-sweep
test-dma-directional-issue-sweep: tests/test_dma_directional_issue_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
...
.PHONY: test-dma-base-scope-sweep
test-dma-base-scope-sweep: tests/test_dma_base_scope_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-base-scope-sweep

.PHONY: test-dma-payload-scope-sweep
test-dma-payload-scope-sweep: tests/test_dma_payload_scope_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-payload-scope-sweep

.PHONY: test-dma-issue-payload-overlap-sweep
test-dma-issue-payload-overlap-sweep: tests/test_dma_issue_payload_overlap_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
...
.PHONY: test-dma-external-boundary-sweep
test-dma-external-boundary-sweep: tests/test_dma_external_boundary_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dma-external-boundary-sweep
...
.PHONY: test-sram-issue-sweep
test-sram-issue-sweep: tests/test_sram_issue_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-sram-issue-sweep

.PHONY: test-dram-row-timeout-sweep
test-dram-row-timeout-sweep: tests/test_dram_row_timeout_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-row-timeout-sweep

.PHONY: test-dram-row-timeout-domain-sweep
test-dram-row-timeout-domain-sweep: tests/test_dram_row_timeout_domain_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-row-timeout-domain-sweep

.PHONY: test-dram-turnaround-sweep
test-dram-turnaround-sweep: tests/test_dram_turnaround_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-turnaround-sweep

.PHONY: test-dram-turnaround-idle-sweep
test-dram-turnaround-idle-sweep: tests/test_dram_turnaround_idle_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-turnaround-idle-sweep

.PHONY: test-dram-directional-burst-sweep
test-dram-directional-burst-sweep: tests/test_dram_directional_burst_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-directional-burst-sweep

.PHONY: test-dram-burst-alignment-sweep
test-dram-burst-alignment-sweep: tests/test_dram_burst_alignment_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
...
test-dram-address-mapping-sweep: tests/test_dram_address_mapping_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-address-mapping-sweep

.PHONY: test-dram-refresh-sweep
test-dram-refresh-sweep: tests/test_dram_refresh_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-refresh-sweep

.PHONY: test-dram-refresh-phase-sweep
test-dram-refresh-phase-sweep: tests/test_dram_refresh_phase_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-refresh-phase-sweep

.PHONY: test-dram-refresh-debt-sweep
test-dram-refresh-debt-sweep: tests/test_dram_refresh_debt_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-refresh-debt-sweep

.PHONY: test-dram-core-clock-sweep
test-dram-core-clock-sweep: tests/test_dram_core_clock_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-dram-core-clock-sweep
...
test-multicore-sweep: tests/test_multicore_scaling_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-multicore-sweep

# ---- Sweep: Per-Core Heterogeneous Dataflow Selection ----
test-multicore-dataflow-sweep: tests/test_multicore_dataflow_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-multicore-dataflow-sweep
...
# ---- Test: Convolution Grouped Sweep (exploration harness) ----
test-conv-groups-sweep: tests/test_conv_groups_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-conv-groups-sweep

# ---- Test: Conv+Pool Cascade Sweep (cross-engine exploration) ----
test-conv-pool-cascade: tests/test_conv_pool_cascade.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-conv-pool-cascade

# ---- Test: Normalization Sweep (LayerNorm vs RMSNorm, exploration harness) ----
test-norm-sweep: tests/test_norm_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-norm-sweep

# ---- Test: Norm-After-Attention Pipeline Sweep (cross-engine exploration) ----
test-norm-attention-sweep: tests/test_norm_attention_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-norm-attention-sweep

# ---- Test: Softmax-After-Attention Pipeline Sweep (cross-engine exploration) ----
test-softmax-attention-sweep: tests/test_softmax_attention_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-softmax-attention-sweep

# ---- Test: Weight Compression (M5) ----
test-compress: tests/test_compress.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -Itests -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-compress

# ---- Sweep: RLE Weight Compression ----
test-weight-compression-sweep: tests/test_weight_compression_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< ./libtucmodel.a $(LDFLAGS)
...
# ---- Test: Scheduler Policy Sweep ----
test-scheduler-sweep: tests/test_scheduler_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
	./test-scheduler-sweep

# ---- Sweep: Interconnect Topology (RING vs MESH) ----
...
# ---- Sweep: Interconnect Contention (ideal parallel vs shared directed links) ----
.PHONY: test-interconnect-contention-sweep
test-interconnect-contention-sweep: tests/test_interconnect_contention_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
	./test-interconnect-contention-sweep

# ---- Sweep: Deterministic Mesh Routing (XY vs YX) ----
.PHONY: test-interconnect-routing-sweep
test-interconnect-routing-sweep: tests/test_interconnect_routing_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -I$(TU_DIR) -o $@ $< ./libtucmodel.a $(LDFLAGS)
...
test-quick: test-config-generation test-cmodel test-reinit test-cmdq test-dma test-dma-burst-boundary-sweep test-dma-external-boundary-sweep test-asm
	@echo ""
...
# ---- Test: MMA + Fused Activation Sweep (cross-engine exploration) ----
test-mma-activation-sweep: tests/test_mma_activation_sweep.c libtucmodel.a
	$(CC) $(CFLAGS) -I. -Itu_cmodel -o $@ $< -L. -ltucmodel $(LDFLAGS)
...
clean:
	...
	rm -f test-cmodel test-reinit test-cmdq test-dma test-dma-channel-sweep test-dma-arbitration-sweep test-dma-binding-sweep test-dma-bus-width-sweep test-dma-directional-latency-sweep test-dma-burst-issue-sweep test-dma-directional-burst-sweep test-dma-directional-issue-sweep test-dma-segmentation-sweep test-dma-base-scope-sweep test-dma-payload-scope-sweep test-dma-issue-payload-overlap-sweep test-dma-burst-boundary-sweep test-dma-external-boundary-sweep test-dram test-sram-issue-sweep test-dram-row-policy-sweep test-dram-row-timeout-sweep test-dram-row-timeout-domain-sweep test-dram-turnaround-sweep test-dram-turnaround-idle-sweep test-dram-directional-burst-sweep test-dram-burst-alignment-sweep test-dram-zero-byte-sweep test-dram-address-mapping-sweep test-dram-refresh-sweep test-dram-refresh-phase-sweep test-dram-refresh-debt-sweep test-dram-core-clock-sweep test-isa test-golden test-golden-full
