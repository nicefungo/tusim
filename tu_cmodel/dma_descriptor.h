 ...
 * stages. Serialized preserves historical additive accounting; overlap
 * models concurrent command production and payload movement. */
typedef enum {
    TU_DMA_ISSUE_PAYLOAD_SERIALIZED = 0,
