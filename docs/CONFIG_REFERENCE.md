...
| `dram_turnaround_mode` | 0 | int | 0=None, 1=Fixed, 2=Idle credit, 3=Exact-byte credit, 4=Payload-size-rounded bursts, 5=Address-span-rounded bursts |
...
| `dma_read_max_burst_bytes` | 0 | uint32 | Read/load burst limit; 0 inherits common maximum |
| `dma_write_max_burst_bytes` | 0 | uint32 | Write/store burst limit; 0 inherits common maximum |
...
| `dma_burst_boundary_mode` | size_only | enum | Burst splitting by size, SRAM alignment, or explicit SRAM/external 4 KiB boundaries |
